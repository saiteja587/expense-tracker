        ...
        <>
          ...
          <div style={{ display: "flex", gap: 32, flexWrap: "wrap", marginBottom: 28 }}>
            <div>
              ...
              <div className="lora tabnum" style={{ fontSize: 36, fontWeight: 600, lineHeight: 1 }}>
            ...
            <div>
              ...
              <div className="lora tabnum" style={{ fontSize: 36, fontWeight: 600, lineHeight: 1, color: "#C98A2C" }}>{currentStreak}</div>
            </div>
            <div>
              ...
              <div className="lora tabnum" style={{ fontSize: 36, fontWeight: 600, lineHeight: 1, color: "#2F6F5E" }}>{longestStreak}</div>
            </div>
            {failedCount > 0 && (
              <div>
                <div style={{ fontSize: 12, color: "#8a8477", marginBottom: 4 }}>Slipped</div>
                <div className="lora tabnum" style={{ fontSize: 36, fontWeight: 600, lineHeight: 1, color: "#A34A38" }}>{failedCount}</div>
              </div>
            )}
          </div>
